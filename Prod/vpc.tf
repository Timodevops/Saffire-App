...
resource "aws_vpc" "saffire_prod_app" {
  cidr_block = "10.0.0.0/16"

  tags = {
    Name = "saffire-prod-app-vpc"
  }
}

# App Tier VPC (private resources)
resource "aws_vpc" "saffire-prod" {
  cidr_block = "10.1.0.0/16"

  tags = {
    Name = "saffire-prod-vpc"
  }
}

# ---------- Internet Gateway & Route Table (Public) ----------

resource "aws_internet_gateway" "saffire_prod_app_igw" {
  vpc_id = aws_vpc.saffire_prod_app.id

  tags = {
    Name = "saffire-prod-app-igw"
  }
}
...
resource "aws_route_table" "public_rt" {
  ...
  route {
    ...
    gateway_id = aws_internet_gateway.saffire_prod_app_igw.id
  }

  tags = {
    Name = "saffire-prod-app-public-rt"
  }
}
...
resource "aws_subnet" "public_subnet_1" {
  ...
  tags = {
    Name = "saffire-prod-app-public-subnet-1"
  }
}
...
resource "aws_subnet" "public_subnet_2" {
  ...
  tags = {
    Name = "saffire-prod-app-public-subnet-2"
  }
}
...
resource "aws_subnet" "private_subnet_1" {
  ...
  tags = {
    Name = "saffire-prod-private-subnet-1"
  }
}
...
resource "aws_subnet" "private_subnet_2" {
  ...
  tags = {
    Name = "saffire-prod-private-subnet-2"
  }
}
